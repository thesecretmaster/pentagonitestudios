---
description: requires an input string "_text_" that will then be output with a random number of typos. Added fucntionality: if the first word is "run#" it will run # times* (*up to 9.) Does not auto-output text.
variables:
  - words
  - text
  - runTimes
